  ...
  <div class="content-wrapper">
    ...
    <?php
      if(isset($_GET["id"])){//URL PERFECTA
        ...
        $administrativa = $objDB->editarADM($_GET["id"]);

        if($administrativa){//VERIFICA QUE LA INFORMACION EXISTE
      ...
      <!-- COLUMNA DE FORMULARIO  -->
        <div class="col-md-12"><!-- columna de contenido -->
            ...
            <div class="card-header bg-indigo">
              <h3 class="card-title">𝘌𝘋𝘐𝘛𝘈𝘙 𝘓𝘐𝘚𝘛𝘈 𝘋𝘌 𝘜𝘚𝘜𝘈𝘙𝘐𝘖𝘚 𝘈𝘋𝘔𝘐𝘕𝘐𝘚𝘛𝘙𝘈𝘛𝘐𝘝𝘈</h3>
            </div>
            ...
            <?php
                if (isset($_POST["txt_Corre"])) {
                  ...
                  $ejecucion = $objDBO->Operaciones("UPDATE administrativa SET correo='$corre',nombre='$nombr',usuario='$user',user_mta='$umta',cargos='$cargo',estado_actual='$estad' WHERE id=$id ");
            ...
            <form role="form" name="frm_prods" id="frm_prods" method="POST" action="editar_Amnsrtv.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
              <div class="card-body">
                 ...
                 <!-- Correo electrónico -->
                  <div class="col-md-4 col-sm-4 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txt_Corre" name="txt_Corre" placeholder="𝘊𝘰𝘳𝘳𝘦𝘰 𝘦𝘭𝘦𝘤𝘵𝘳ó𝘯𝘪𝘤𝘰" value="<?php echo $administrativa[0]['correo']; ?>">
                    </div> 
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txt_Nombr" name="txt_Nombr" placeholder="𝘕𝘰𝘮𝘣𝘳𝘦 𝘊𝘰𝘮𝘱𝘭𝘦𝘵𝘰" value="<?php echo $administrativa[0]['nombre']; ?>">
                    </div> 
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txt_User" name="txt_User" placeholder="𝘜𝘴𝘶𝘢𝘳𝘪𝘰 𝘋𝘪𝘴𝘤𝘰𝘳𝘥" value="<?php echo $administrativa[0]['usuario']; ?>">
                    </div> 
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txt_Mta" name="txt_Mta" placeholder="𝘜𝘴𝘶𝘢𝘳𝘪𝘰 𝘔𝘛𝘈" value="<?php echo $administrativa[0]['user_mta']; ?>">
                    </div> 
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 col-12">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="lst_Cargo" id="lst_Cargo">
                        <option value="" hidden><?php echo $administrativa[0]['cargos']; ?></option>
                  ...
                  <div class="col-md-4 col-sm-4 col-12">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="lst_Estad" id="lst_Estad">
                        <option value="" hidden><?php echo $administrativa[0]['estado_actual']; ?></option>
              ...
              <div class="card-footer" align="center">
                ...
                <a href="lista_Amnsrtv.php" class="btn btn-info">
                       <i class="nav-icon fas a-solid fa-clipboard"></i> 
                                                          𝘝𝘦𝘳 𝘓𝘪𝘴𝘵𝘢𝘴</a>

              </div>

              <input type="hidden" name="txt_id" id="txt_id" value="<?php echo $administrativa[0]['id']; ?>">
