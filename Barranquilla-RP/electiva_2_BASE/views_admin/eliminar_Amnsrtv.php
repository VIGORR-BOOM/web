              ...
              <div class="card">
                ...
                <?php
                  if(isset($_POST["txt_id"])){
                    ...
                    $ejecucion = $objDBO->Operaciones("DELETE FROM administrativa 
                                                       WHERE id=$id");
                ...
                <form role="form" id="frm_prods" name="frm_prods" method="POST" action="eliminar_Amnsrtv.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">

                  <div class="card-body">
                       𝘜𝘴𝘵𝘦𝘥 𝘷𝘢 𝘢 𝘌𝘭𝘪𝘮𝘪𝘯𝘢𝘳 𝘦𝘭 𝘜𝘴𝘶𝘢𝘳𝘪𝘰
                       <b><?php echo $administrativa[0]['user_mta']; ?></b>
                       𝘤𝘰𝘯 𝘊𝘢𝘳𝘨𝘰 
                       <b><?php echo $administrativa[0]['cargos']; ?></b>
                       𝘐𝘋
                       <b><?php echo $administrativa[0]['id']; ?></b>
                       <br>
                  ...
                  <div class="card-footer">
                    ...
                    <a href="lista_Amnsrtv.php" class="btn btn-warning"><i class="nav-icon fas fa-ban"></i> 𝘊𝘢𝘯𝘤𝘦𝘭𝘢𝘳</a>
                  </div>

                  <input type="hidden" id="txt_id" name="txt_id" value="<?php echo $administrativa[0]['id']; ?>">
