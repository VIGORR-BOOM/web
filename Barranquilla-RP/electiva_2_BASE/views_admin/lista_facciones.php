  ...
  <div class="content-wrapper">
    ...
    <?php
      ...
      if(isset($_POST["txtBuscar"])){ //se filtro algo
         $prods = $objDB->busquedaFAC($_POST["txtBuscar"]); //filtramos coincidencia
      }else{
        $prods = $objDB->listadoFAC(); //traemos todo
      }
    ...
    <section class="content">
        ...
        <div class="row d-none d-print-block"><!-- fila contenedora -->
          <div class="col-md-12"> <!-- fin columna de contenido -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <img src="../imgs/Facciones.png" width="100%">
              </div> <!-- /.fin card-body -->
            </div>
          </div> <!--/ fin col -->
        </div><!-- ./ fin row -->
        ...
        <div class="row d-print-none">.<!--fila contenedora-->
         ...
         <div class="col-md-12"> <!-- fin columna de contenido -->
          ...
          <form name="frm_filtro" id="frm_filtro" method="POST" action="lista_facciones.php">
              <div class="card">
                 ...
                 <div class="card-body">
                    ...
                    <div class="input-group input-group-sm">
                      ...
                      <span class="input-group-append">
                        ...
                        <a href="lista_facciones.php" class="btn btn-danger">
      ...
      <div class="row">
        ...
        <div class="col-md-12"><!--  -->
          ...
          <div class="card">
              <div class="card-header bg-indigo">
                <h3 class="card-title">𝘓𝘐𝘚𝘛𝘈𝘚 𝘋𝘌 𝘍𝘈𝘊𝘊𝘐𝘖𝘕𝘌𝘚</h3>
              </div>
              <!-- /.card-header -->
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="editar_facciones.php?id=<?php echo $row["id"]; ?>"  class="bnt btn-xs btn-warning"><i class="fa fa-edit"></i></a>

                        <a href="eliminar_facciones.php?id=<?php echo $row["id"]; ?>" class="bnt btn-xs btn-danger"><i class="fa fa-trash"></i></a>
