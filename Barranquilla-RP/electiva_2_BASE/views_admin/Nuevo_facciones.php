        ...
        <div class="col-md-12"><!-- columna de contenido -->
            ...
            <?php
                if (isset($_POST["txt_Corre"])) {
                  ...
                  $ejecucion = $objDBO->Operaciones("INSERT INTO facciones(correo,nombre,usuario,user_mta,cargos,estado_actual) 
                  ...
                  if($ejecucion){
                    echo "<div class='alert alert-success'>
                          ...
                          <a href='lista_facciones.php' class='btn btn-default'>Ver Listado</a>";
            ...
            <form role="form" name="frm_AmnS" id="frm_AmnS" method="POST" action="Nuevo_facciones.php" enctype="multipart/form-data">
              <div class="card-body">
              ...
              <div class="card-footer" align="center">
                ...
                <button type="submit" class="btn btn-warning"><i class="nav-icon fas fa-solid fa-box" id="btn_Registrar"></i> 𝘙𝘦𝘨𝘪𝘴𝘵𝘳𝘢𝘳 𝘍𝘤𝘪𝘯𝘴 </button>
