  ...
  <div class="content-wrapper">
    ...
    <?php
      ...
      if(isset($_POST["txtBuscar"])){ //se filtro algo
         $prods = $objDB->busquedaADM($_POST["txtBuscar"]); //filtramos coincidencia
      }else{
        $prods = $objDB->listadoADM(); //traemos todo
      }
    ...
    <section class="content">
        ...
        <div class="row d-none d-print-block"><!-- fila contenedora -->
          <div class="col-md-12"> <!-- fin columna de contenido -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <img src="../imgs/administrativa.png" width="100%">
              </div> <!-- /.fin card-body -->
            </div>
          </div> <!--/ fin col -->
        </div><!-- ./ fin row -->
        ...
        <div class="row d-print-none">.<!--fila contenedora-->
         ...
         <div class="col-md-12"> <!-- fin columna de contenido -->
          ...
          <form name="frm_filtro" id="frm_filtro" method="POST" action="lista_Amnsrtv.php">
              <div class="card">

                  <div class="card-header bg-indigo">
                   <h3 class="card-title"> 𝘍𝘪𝘭𝘵𝘢𝘳 𝘜𝘴𝘶𝘢𝘳𝘪𝘰𝘴 </h3>
                 </div>
                 <!-- /. card-header-->

                 <!--Para controles de formularios siempre usar etiqueta FORM -->
                 <div class="card-body">
                    <label for="txtBuscar">𝘗𝘰𝘳 𝘊𝘢𝘳𝘨𝘰𝘴</label>
                    <div class="input-group input-group-sm">
                      <input type="text" id="txtBuscar" name="txtBuscar" class="form-control">
                      <span class="input-group-append">
                        <button type="submit" class="btn btn-warning">
                        <i class="fa-solid fa-magnifying-glass" style="color: #4a4e54;"></i>
                         𝘉𝘶𝘴𝘤𝘢𝘳</button>

                        <a href="lista_Amnsrtv.php" class="btn btn-danger">
      ...
      <div class="row">
        ...
        <div class="col-md-12"><!--  -->
          ...
          <div class="card">
              <div class="card-header bg-indigo">
                <h3 class="card-title">𝘓𝘐𝘚𝘛𝘈𝘚 𝘋𝘌 𝘈𝘋𝘔𝘐𝘕𝘐𝘚𝘛𝘙𝘈𝘛𝘐𝘝𝘖</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body p-0">
                <?php if($prods) //verifiva si hay registro de datos ?>
                  <a href="#" id="btn_print" class="btn btn-info btn-xs float-right d-print-none"><i class="fa fa-print"></i>𝘐𝘮𝘱𝘳𝘪𝘮𝘪𝘳</a>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="editar_Amnsrtv.php?id=<?php echo $row["id"]; ?>"  class="bnt btn-xs btn-warning"><i class="fa fa-edit"></i></a>

                        <a href="eliminar_Amnsrtv.php?id=<?php echo $row["id"]; ?>" class="bnt btn-xs btn-danger"><i class="fa fa-trash"></i></a>
